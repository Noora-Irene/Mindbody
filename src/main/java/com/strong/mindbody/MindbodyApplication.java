...
public class MindbodyApplication {
	...
	public CommandLineRunner demo(NoteRepository noterepo, WorkoutRepository workoutrepo, PowerRepository powerrepo, UserRepository userrepo) {
		return (args) -> {
			...
			User user1 = new User("ohjaaja", "$2a$10$0MMwY.IQqpsVc1jC8u7IJ.2rT8b0Cd3b3sfIBGV2zfgnPGtT4r0.C", "ADMIN");
			User user2 = new User("MyFriend", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "USER");
				userrepo.save(user1);
				userrepo.save(user2);
